...
namespace KCA_TournamentAPI.Migrations
{
    ...
    [Migration("20250618075010_AddStatsTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KCA_TournamentAPI.Models.PlayerStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCA_TournamentAPI.Models.PlayerStats", b =>
                {
                    b.HasOne("KCA_TournamentAPI.Models.Player", "Player")
                        .WithOne("Stats")
                        .HasForeignKey("KCA_TournamentAPI.Models.PlayerStats", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
