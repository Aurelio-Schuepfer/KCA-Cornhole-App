...
{
    /// <inheritdoc />
    public partial class FixParticipantsRelation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BracketType = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Brackets_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Brackets_Matches_NextMatchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Brackets_MatchId",
                table: "Brackets",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_Brackets_NextMatchId",
                table: "Brackets",
                column: "NextMatchId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PlayerStats_Participants_PlayerId",
                table: "PlayerStats",
                column: "PlayerId",
